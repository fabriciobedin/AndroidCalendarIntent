...
//        day_x = cal.get(Calendar.DAY_OF_MONTH);
        ...
        mOutputText = (TextView) findViewById(R.id.txtVerEventos);
        mCallApiButton = (Button) findViewById(R.id.btVerEventos);

        mProgress = new ProgressDialog(this);
        mProgress.setMessage("Procurando na Google Calendar API ...");
